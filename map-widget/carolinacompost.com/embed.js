...
(function() {
	...
	var mapUrl = 'embed.html?r=1';
	if (window.location.hostname != 'localhost' && window.location.port != 8000) mapUrl = 'https://compostnow.github.io/map-widget/carolinacompost.com/' + mapUrl;
